...
/* ===============================
   WELLNESS INSIGHT (CROSS ANALYSIS)
=============================== */
...
function generateWellnessInsight() {
  ...
  // --- count joined activities by category ---
  ...
  // --- top activity category (joined-based, fallback to overall) ---
  ...
  // --- compare using normalized categories ---
  if (
